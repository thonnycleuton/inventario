...
from inventario.views import ListProduto, CreateProduto, UpdateProduto, DeleteProduto, \
    ...
    ListSetor, CreateSetor, UpdateSetor, DeleteSetor, setor_delete, colaborador_delete
...
urlpatterns = [
    ...
    url(r'^colaborador-delete/(?P<pk>\d+)/$', colaborador_delete, name='colaborador_delete'),
    ...
    url(r'^setor-delete/(?P<pk>\d+)/$', setor_delete , name='setor_delete'),
]
